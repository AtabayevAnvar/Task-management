      ...
      <div class="dropdown" style="position:relative;">
        ...
        <div class="notif-dropdown" id="notifDropdown">
          <div class="notif-header">
            <strong style="font-size:var(--text-sm)">Bildirishnomalar</strong>
            <button class="btn btn-ghost btn-sm" id="markAllRead">Barchasini o'qish</button>
          </div>
          <div class="notif-list" id="notifList"></div>
        </div>
      </div>
      <div class="header-user" id="headerUser">
        <div class="avatar" id="headerAvatar">AA</div>
      </div>
    </div>
  `;
}
